...
public class MarioWorld {
    ...
    public MarioEvent[] killEvents;
    public ArrayList<MarioSprite> sprites;
    public ArrayList<Shell> shellsToCheck;
    public ArrayList<Fireball> fireballsToCheck;
    public ArrayList<MarioSprite> addedSprites;
    public ArrayList<MarioSprite> removedSprites;

    private ArrayList<MarioEffect> effects;

    public MarioBackground[] backgrounds = new MarioBackground[2];
